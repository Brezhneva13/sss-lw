                ...
                <div class="container-fluid px-4">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_client'])) {
                        ...
                        if (!preg_match('/^\+?[0-9]{10,15}$/', $phone)) {
                            echo "<div class='alert alert-danger'>Ошибка: Неверный формат телефона.</div>";
                            return;
                        }

                        // Проверка формата номера карты
                        if (!preg_match('/^[0-9]{16}$/', $cardNumber)) {
                            echo "<div class='alert alert-danger'>Ошибка: Неверный формат номера карты.</div>";
                            return;
                        }
                        ...
                        <div class="card-body">
                            <form method="POST" action="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="phone" value="<?php echo $editClient['Phone'] ?? ''; ?>" required pattern="^\+?[0-9]{10,15}$" title="Неверный формат телефона">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="cardNumber" value="<?php echo $editClient['CardNumber'] ?? ''; ?>" required pattern="^[0-9]{16}$" title="Неверный формат номера карты">
                                </div>
